...
public class Rotations {
    ...
    static {
        KorppuMod.eventManager.register(Rotations.class);
    }
    ...
    @Listener
    public static void onPacketSend(PacketEvent.Sent event) {
    ...
    @Listener
    public static void onPacketReceive(PacketEvent.Received pe) {
        if (!enabled) {
            return;
        }
